...
dotfiles_include "kubernetes" && sources+=("$DOTFILES/kubernetes/rosenberg.kubernetes.sh")
...
dotfiles_include "terraform"  && sources+=("$DOTFILES/Terraform/rosenberg.terraform.bash")
