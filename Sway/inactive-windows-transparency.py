...
# source: https://github.com/swaywm/sway/blob/master/contrib/inactive-windows-transparency.py
# edited by Jeff Rosenberg
...
def on_window_focus(inactive_opacity, ipc, event):
    ...
    if focused.id != prev_focused.id:  # https://github.com/swaywm/sway/issues/2859
        ...
        if workspace == prev_workspace:
            if prev_focused.floating not in ["auto_on", "user_on"]:
